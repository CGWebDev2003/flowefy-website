    ...
    return (
        <>
            <div className='inquirySection'>
                <div
                    className='toast successToast animate__animated animate__animate__backInUp'
                    id='successToast'
                >
                    <p>Anfrage erfolgreich versendet!</p>
                </div>
                <div
                    className='toast errorToast animate__animated animate__animate__backInUp'
                    id='errorToast'
                >
                    <p>Anfrage erfolgreich versendet!</p>
                </div>
                <div className='mainContent'>
                    <div className='inquiryContainer'>
                        <div className='inquiryFormBox'>
                            <h1 className='headline inquiryHeadline'>
